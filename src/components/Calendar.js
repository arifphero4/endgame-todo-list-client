...
const Calendar = () => {
  ...
  const handleAddTask = () => {
    ...
    const url = `https://stormy-bastion-67814.herokuapp.com/api/addingTodo`;
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <button
            ...
            className="bg-green-600 text-white px-5 py-1 mt-3 mx-8 rounded hover:scale-125 duration-300 ease-in-out"
          >
            Add
          </button>
        </form>
